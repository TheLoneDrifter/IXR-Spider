...
import com.voltaccept.spideranimation.utilities.namespacedID
import com.voltaccept.spideranimation.utilities.requireCommand
...
class CustomItemComponent(val id: String) {
    ...
    fun onInteractEntity(action: (Player, Entity, ItemStack) -> Unit) {
        com.voltaccept.spideranimation.utilities.events.onInteractEntity(fun(player, entity, hand) {
